...
var $Voronchuk$hexagons$Hexagons$Map$rectangularFlatTopMap = F2(
	function (height, width) {
		var widthLine = A2($elm$core$List$range, 0, width);
		var offsetHeight = F2(
			function (q, r) {
				return r - ((q / 2) | 0);
			});
		var makeDictRecord = function (hex) {
			return _Utils_Tuple2(
				$Voronchuk$hexagons$Hexagons$Map$hashHex(hex),
				hex);
		};
		var heightLine = A2($elm$core$List$range, 0, height);
		var createHex = F2(
			function (q, r) {
				return $Voronchuk$hexagons$Hexagons$Hex$intFactory(
					_Utils_Tuple2(q, r));
			});
		var widthColumnLine = function (q) {
			return A2(
				$elm$core$List$map,
				createHex(q),
				A2(
		...
		var allLines = $elm$core$List$concat(
			A2($elm$core$List$map, widthColumnLine, widthLine));
		return $elm$core$Dict$fromList(
			A2($elm$core$List$map, makeDictRecord, allLines));
	});
var $author$project$Main$emptyModel = {
	J: A2($Voronchuk$hexagons$Hexagons$Map$rectangularFlatTopMap, 6, 6),
	w: $elm$core$Dict$empty,
	aq: $elm$time$Time$millisToPosix(0)
};
...
var $author$project$Main$evolveCells = A2(
	$elm$core$Basics$composeR,
	$elm$core$Dict$map(
		F2(
			function (_v0, n) {
				return A2($elm$core$Basics$max, 0, n - 1);
			})),
...
var $author$project$Main$lightestGradient = '#e9ecef';
var $author$project$Main$gradients = $elm$core$Array$fromList(
	_List_fromArray(
		[$author$project$Main$lightestGradient, '#e0e0e0', '#dcdcdc', '#d8d8d8', '#d3d3d3', '#d0d0d0', '#c8c8c8', '#c0c0c0', '#bebebe', '#b8b8b8', '#b0b0b0', '#a9a9a9', '#a8a8a8', '#a0a0a0', '#989898', '#909090', '#888888', '#808080', '#787878', '#707070', '#696969', '#686868', '#606060']));
var $elm$core$Array$length = function (_v0) {
	var len = _v0.a;
	return len;
};
var $author$project$Main$markCell = function (cell) {
	return A2(
		$elm$core$Dict$insert,
		cell,
		$elm$core$Array$length($author$project$Main$gradients) - 1);
};
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							w: $author$project$Main$evolveCells(model.w)
						}),
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							w: A2($author$project$Main$markCell, cell, model.w)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $elm$svg$Svg$Attributes$height = _VirtualDom_attribute('height');
var $author$project$Main$MarkCell = function (a) {
	return {$: 2, a: a};
};
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $elm$svg$Svg$trustedNode = _VirtualDom_nodeNS('http://www.w3.org/2000/svg');
var $elm$svg$Svg$g = $elm$svg$Svg$trustedNode('g');
var $author$project$Main$getCell = function (_v0) {
	var hex = _v0.b;
	return hex;
};
var $author$project$Main$getCellKey = function (_v0) {
	var key = _v0.a;
	return key;
};
var $author$project$Main$darkestGradient = '#585858';
...
var $author$project$Main$hexColor = F2(
	function (hash, model) {
		var collatz = function (n) {
			return (!n) ? 0 : ((!A2($elm$core$Basics$modBy, 2, n)) ? ((n / 2) | 0) : ((3 * n) + 1));
		};
		var collatzColor = function (n) {
			return A2(
				$elm$core$Array$get,
				A2(
					$elm$core$Basics$modBy,
					$elm$core$Array$length($author$project$Main$gradients),
					collatz(n)),
				$author$project$Main$gradients);
		};
		return A2(
			$elm$core$Maybe$withDefault,
			$author$project$Main$darkestGradient,
			collatzColor(
				A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($elm$core$Dict$get, hash, model.w))));
	});
var $author$project$Main$cellHeight = 16.0;
var $author$project$Main$cellWidth = 16.0;
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $Voronchuk$hexagons$Hexagons$Layout$orientationLayoutPointy = {
	K: {
		r: $elm$core$Basics$sqrt(3.0),
		s: $elm$core$Basics$sqrt(3.0) / 2.0,
		t: 0.0,
		u: 3.0 / 2.0
	},
	L: {
		r: $elm$core$Basics$sqrt(3.0) / 3.0,
		s: (-1.0) / 3.0,
		t: 0.0,
		u: 2.0 / 3.0
	},
...
var $author$project$Main$layout = {
	aI: $Voronchuk$hexagons$Hexagons$Layout$orientationLayoutPointy,
	aJ: _Utils_Tuple2(0.0, 80.0),
	aL: _Utils_Tuple2($author$project$Main$cellWidth, $author$project$Main$cellHeight)
};
...
var $Voronchuk$hexagons$Hexagons$Layout$hexCornerOffset = F2(
	function (layout, corner) {
		var startAngle = layout.aI.M;
		var angle = ((2.0 * $elm$core$Basics$pi) * (corner + startAngle)) / 6;
		var _v0 = layout.aL;
		var xl = _v0.a;
		var yl = _v0.b;
		var x = A2(
			$Voronchuk$hexagons$Hexagons$Layout$precision,
			2,
			xl * $elm$core$Basics$cos(angle));
		var y = A2(
			$Voronchuk$hexagons$Hexagons$Layout$precision,
			2,
			yl * $elm$core$Basics$sin(angle));
...
var $Voronchuk$hexagons$Hexagons$Layout$polygonCorners = F2(
	function (layout, hex) {
		var offsetHex = F2(
			function (_v1, _v2) {
				var x__ = _v1.a;
				...
				var y_ = _v2.b;
				return _Utils_Tuple2(
					A2($Voronchuk$hexagons$Hexagons$Layout$precision, 2, x__ + x_),
					A2($Voronchuk$hexagons$Hexagons$Layout$precision, 2, y__ + y_));
			});
		var _v0 = A2($Voronchuk$hexagons$Hexagons$Layout$hexToPoint, layout, hex);
		var x = _v0.a;
		var y = _v0.b;
		return A2(
			$elm$core$List$map,
			...
			A2(
				$elm$core$List$map,
				$Voronchuk$hexagons$Hexagons$Layout$hexCornerOffset(layout),
				A2($elm$core$List$range, 0, 5)));
	});
var $author$project$Main$mapPolygonCorners = $Voronchuk$hexagons$Hexagons$Layout$polygonCorners($author$project$Main$layout);
...
var $author$project$Main$pointToStringCoords = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
...
var $author$project$Main$pointsToString = function (points) {
	return A2(
		$elm$core$String$join,
		' ',
		A2($elm$core$List$map, $author$project$Main$pointToStringCoords, points));
};
var $elm$svg$Svg$polygon = $elm$svg$Svg$trustedNode('polygon');
var $elm$svg$Svg$Attributes$stroke = _VirtualDom_attribute('stroke');
var $elm$svg$Svg$Attributes$strokeWidth = _VirtualDom_attribute('stroke-width');
var $elm$svg$Svg$Attributes$style = _VirtualDom_attribute('style');
var $author$project$Main$hexGrid = function (model) {
	var toPolygon = F2(
		function (hexLocation, cornersCoords) {
			return _List_fromArray(
				[
					A2(
					$elm$svg$Svg$polygon,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$style('cursor: arrow'),
							$elm$svg$Svg$Attributes$stroke('#ffffff'),
							$elm$svg$Svg$Attributes$strokeWidth('1px'),
							$elm$svg$Svg$Attributes$fill(
							A2($author$project$Main$hexColor, hexLocation, model)),
							$elm$svg$Svg$Attributes$points(cornersCoords),
							$elm$svg$Svg$Events$onMouseOver(
							$author$project$Main$MarkCell(hexLocation))
						]),
					_List_Nil)
				]);
		});
	var toSvg = F2(
		function (hexLocation, cornersCoords) {
			return A2(
				$elm$svg$Svg$g,
				_List_Nil,
				A2(toPolygon, hexLocation, cornersCoords));
		});
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		A3(
			...
			A2(
				$elm$core$List$map,
				$author$project$Main$getCellKey,
				$elm$core$Dict$toList(model.J)),
			A2(
				$elm$core$List$map,
				A2(
					$elm$core$Basics$composeL,
					A2($elm$core$Basics$composeL, $author$project$Main$pointsToString, $author$project$Main$mapPolygonCorners),
					$author$project$Main$getCell),
				$elm$core$Dict$toList(model.J))));
};
var $elm$virtual_dom$VirtualDom$lazy = _VirtualDom_lazy;
var $elm$svg$Svg$Lazy$lazy = $elm$virtual_dom$VirtualDom$lazy;
var $elm$svg$Svg$svg = $elm$svg$Svg$trustedNode('svg');
var $author$project$Main$svgHeight = 256;
var $author$project$Main$svgWidth = 256;
var $elm$svg$Svg$Attributes$version = _VirtualDom_attribute('version');
var $elm$svg$Svg$Attributes$viewBox = _VirtualDom_attribute('viewBox');
var $author$project$Main$viewBoxStringCoords = $elm$core$String$fromFloat((-$author$project$Main$cellWidth) + ($author$project$Main$cellWidth * 0.1)) + (' ' + ($elm$core$String$fromFloat(-($author$project$Main$cellHeight + 0)) + (' ' + ($elm$core$String$fromInt($author$project$Main$svgWidth) + (' ' + $elm$core$String$fromInt($author$project$Main$svgHeight))))));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$String$fromInt($author$project$Main$svgHeight)),
				$elm$svg$Svg$Attributes$width(
				$elm$core$String$fromInt($author$project$Main$svgWidth)),
				$elm$svg$Svg$Attributes$viewBox($author$project$Main$viewBoxStringCoords)
			]),
		_List_fromArray(
			[
				A2($elm$svg$Svg$Lazy$lazy, $author$project$Main$hexGrid, model)
			]));
};
